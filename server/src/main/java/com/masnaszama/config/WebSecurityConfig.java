package com.masnaszama.config;

import com.masnaszama.model.User;
import com.masnaszama.security.auth.*;
import com.masnaszama.service.impl.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.csrf().ignoringAntMatchers("/api/login", "/api/signup", "/order/createNewOrder/**")
