...
INSERT INTO user (id, username, password, phonenumber, first_name, last_name,img_url) VALUES (3, 'kurier', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 8924843813, 'daniel', 'jończyk','https://firebasestorage.googleapis.com/v0/b/masnaszamcia.appspot.com/o/accImg%2Fuser.png?alt=media&token=8bde7c6f-0899-4ac0-aced-3cb2f742483b');
...
insert into employee  values(4, 'damian', 'linek', 623999000, 44);
